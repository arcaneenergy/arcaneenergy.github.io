...
function _createMdxContent$1(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.h2, {
      ...
      children: "This privacy policy applies to all services, websites and games from Arcane Energy. This page is used to inform visitors, regarding the policies with the collection, use, and disclosure of personal information. By using the services, you agree to the collection and use of information in relation to this policy. Personal information that is\ncollected, is used for providing and improving the services. Your data will not be shared with anyone, except as described in this privacy policy."
    }), "\n", createVNode(_components.h2, {
      id: "information-collection",
      children: "Information collection"
    }), "\n", createVNode(_components.p, {
      children: "To enhance your experience while using the service, it may be necessary to collect certain information about your device, including but not limited to device or other IDs (such as Advertising ID, Android ID, IMEI, BSSID):"
    }), "\n", createVNode(_components.ul, {
      children: ["\n", createVNode(_components.li, {
        children: "Device ID: A unique identifier generated by your device."
      }), "\n", createVNode(_components.li, {
        children: "Device Model: The name or model of your device."
      }), "\n", createVNode(_components.li, {
        children: "OS Version: The version of the operating system running on your device."
      }), "\n"]
    }), "\n", createVNode(_components.p, {
      children: "This information is collected to ensure the functionality of the service and to diagnose bugs. The collected data is stored securely, not shared with third parties, and cannot be used to personally identify you."
    }), "\n", createVNode(_components.p, {
      children: "Third party services may be used, that may collect information used to identify you. Link to the privacy policy of third-party service providers used by the apps are linked here:"
    }), "\n", createVNode(_components.ul, {
      children: ["\n", createVNode(_components.li, {
      ...
      children: "Cookies and similar tracking technologies may be used to track the activity on these services. Cookies are files with small amount of data, which may include an anonymous unique identifier. Cookies are sent to your browser from a website and stored on your device. You can instruct your browser to refuse all cookies or to indicate when a cookie is being sent. However, if you do not accept cookies, you may not be able to use some portions of the services."
    }), "\n", createVNode(_components.p, {
      ...
      children: "For optimal security, all application updates should be installed regularly. It is also recommended to regularly check for available updates and turn on automatic updates."
    }), "\n", createVNode(_components.h2, {
      id: "links",
      children: "Links"
    }), "\n", createVNode(_components.p, {
      children: "The services may contain links to other sites. If you click on a third-party link, you will be directed to that site. These external sites are not operated by Arcane Energy. Therefore, it is advised to review the privacy policy of these websites. No responsibility for the content, privacy policies, or practices of any third-party sites or services are taken."
    }), "\n", createVNode(_components.h2, {
