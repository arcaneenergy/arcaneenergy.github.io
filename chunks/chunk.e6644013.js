...
const $$GooglePlayButton = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead($$result)}<a${addAttribute(`https://play.google.com/store/apps/details?id=${embedId}`, "href")} class="p-4 bg-black rounded-lg shadow-lg text-white text-lg font-bold no-underline hover:bg-orange hover:text-black transition-all flex items-center w-fit border-gray border-2 astro-NHJO2Z25">
    ...
    <span class="astro-NHJO2Z25">Download on Google Play Store</span>
</a>`;
