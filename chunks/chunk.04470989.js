...
const $$GithubButton = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead($$result)}<a${addAttribute(`https://github.com/arcaneenergy/${embedId}`, "href")} class="p-4 bg-black rounded-lg shadow-lg text-white text-lg font-bold no-underline hover:bg-orange hover:text-black transition-all flex items-center w-fit border-gray border-2 astro-PTGARI7I">
