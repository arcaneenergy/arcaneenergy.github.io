...
const entryGlob = /* #__PURE__ */ Object.assign({"/src/content/posts/2d-physics-sandbox.mdx": () => import('./chunk.e9d3a951.js'),"/src/content/posts/animated-explosions-pack-1.mdx": () => import('./chunk.e62169d9.js'),"/src/content/posts/control-cube.mdx": () => import('./chunk.fde7b8e6.js'),"/src/content/posts/divided-chains-combined-brains.mdx": () => import('./chunk.42b0be04.js'),"/src/content/posts/icosahedron.mdx": () => import('./chunk.d1d3bf24.js'),"/src/content/posts/limspace-v1.mdx": () => import('./chunk.a6687012.js'),"/src/content/posts/mergifier.mdx": () => import('./chunk.b7b37b8d.js'),"/src/content/posts/metal-ball-adventures.mdx": () => import('./chunk.e559a6ad.js'),"/src/content/posts/multimesh-scatter.mdx": () => import('./chunk.fc85755e.js'),"/src/content/posts/rocket-bounce.mdx": () => import('./chunk.52f0a966.js'),"/src/content/posts/sm-pdf-viewer.mdx": () => import('./chunk.05a36b06.js'),"/src/content/posts/sm-text-editor.mdx": () => import('./chunk.7b0589d9.js'),"/src/content/posts/squash-stretch-shader.mdx": () => import('./chunk.7c3302dd.js'),"/src/content/posts/tilemap-level-editor.mdx": () => import('./chunk.96512c9c.js'),"/src/content/posts/top-down-shooter-tutorial-series.mdx": () => import('./chunk.d9320740.js'),"/src/content/posts/vignette-shader.mdx": () => import('./chunk.56a37e32.js'),"/src/content/posts/voxelgi-scene.mdx": () => import('./chunk.a4a8698a.js'),"/src/content/posts/walking-simulator.mdx": () => import('./chunk.f69168d7.js'),"/src/content/posts/whiteboard.mdx": () => import('./chunk.e3c34844.js')
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/posts/2d-physics-sandbox.mdx": () => import('./chunk.07e10866.js'),"/src/content/posts/animated-explosions-pack-1.mdx": () => import('./chunk.afff880e.js'),"/src/content/posts/control-cube.mdx": () => import('./chunk.10096977.js'),"/src/content/posts/divided-chains-combined-brains.mdx": () => import('./chunk.b060aec2.js'),"/src/content/posts/icosahedron.mdx": () => import('./chunk.0f39a2ab.js'),"/src/content/posts/limspace-v1.mdx": () => import('./chunk.3cf30ad9.js'),"/src/content/posts/mergifier.mdx": () => import('./chunk.9d248bb0.js'),"/src/content/posts/metal-ball-adventures.mdx": () => import('./chunk.2cdcecb2.js'),"/src/content/posts/multimesh-scatter.mdx": () => import('./chunk.85879dc6.js'),"/src/content/posts/rocket-bounce.mdx": () => import('./chunk.cb33b6f2.js'),"/src/content/posts/sm-pdf-viewer.mdx": () => import('./chunk.74c6525d.js'),"/src/content/posts/sm-text-editor.mdx": () => import('./chunk.a5a942ab.js'),"/src/content/posts/squash-stretch-shader.mdx": () => import('./chunk.b4dd6ced.js'),"/src/content/posts/tilemap-level-editor.mdx": () => import('./chunk.7104ff1b.js'),"/src/content/posts/top-down-shooter-tutorial-series.mdx": () => import('./chunk.fdc2cd6f.js'),"/src/content/posts/vignette-shader.mdx": () => import('./chunk.040619bf.js'),"/src/content/posts/voxelgi-scene.mdx": () => import('./chunk.da2bf47b.js'),"/src/content/posts/walking-simulator.mdx": () => import('./chunk.23adf64f.js'),"/src/content/posts/whiteboard.mdx": () => import('./chunk.77988315.js')
        ...
        ${breadcrumbList.map((breadcrumb, value) => renderTemplate`<li class="astro-ILHXCYM7">
                    <a${addAttribute(breadcrumb["path"], "href")} class="astro-ILHXCYM7">
                        ${breadcrumb["icon"] && renderTemplate`<span class="pr-2 astro-ILHXCYM7">
                                ${renderComponent($$result, "Fragment", Fragment, {}, { "default": () => renderTemplate`${unescapeHTML(breadcrumb["icon"])}` })}
                            </span>`}
                        ${breadcrumb["title"]}
                    </a>
...
const $$page = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Generic", $$Generic, { "title": "Posts", "description": "All posts.", "class": "astro-6PAWVVAF" }, { "default": () => renderTemplate`${maybeRenderHead($$result)}<div class="filter astro-6PAWVVAF">
		...
		<a href="/tags/game" class="astro-6PAWVVAF">
			<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" class="astro-6PAWVVAF">
				<path stroke="none" d="M0 0h24v24H0z" fill="none" class="astro-6PAWVVAF"></path>
...
const $$Article = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Article;
  const { title, description, datetime, heroImage } = Astro2.props;
  return renderTemplate`${renderComponent($$result, "Base", $$Base, { "title": title, "description": description, "image": heroImage, "class": "astro-UWV4MMHS" }, { "default": () => renderTemplate`${renderComponent($$result, "Header", $$Header, { "class": "astro-UWV4MMHS" })}${renderComponent($$result, "Breadcrumbs", $$Breadcrumbs, { "title": title, "class": "astro-UWV4MMHS" })}${renderSlot($$result, $$slots["before-content"])}${maybeRenderHead($$result)}<main class="astro-UWV4MMHS">
        <div class="info astro-UWV4MMHS">
            ...
            ${datetime && renderTemplate`${renderComponent($$result, "Datetime", $$Datetime, { "datetime": datetime, "class": "astro-UWV4MMHS" })}`}
        </div>

        <article class="astro-UWV4MMHS">
            ${renderSlot($$result, $$slots["default"])}
        </article>
    </main>${renderSlot($$result, $$slots["after-content"])}${renderComponent($$result, "Footer", $$Footer, { "class": "astro-UWV4MMHS" })}` })}`;
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Article", $$Article, { "title": post.data.title, "description": post.data.description, "datetime": post.data.datetime, "heroImage": post.data.heroImage, "class": "astro-GYSQO7GH" }, { "after-content": () => renderTemplate`${maybeRenderHead($$result)}<ul class="tags astro-GYSQO7GH">
		${post.data.tags.map((tag) => renderTemplate`<li class="astro-GYSQO7GH">
					${renderComponent($$result, "Tag", $$Tag, { "tag": tag, "class": "astro-GYSQO7GH" })}
				</li>`)}
	</ul>`, "default": () => renderTemplate`${renderComponent($$result, "Content", Content, { "class": "astro-GYSQO7GH" })}` })}`;
...
const $$404 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Base", $$Base, { "title": "404", "description": "404 - Page not found.", "class": "astro-ZETDM5MD" }, { "default": () => renderTemplate`${renderComponent($$result, "Header", $$Header, { "class": "astro-ZETDM5MD" })}${maybeRenderHead($$result)}<main class="astro-ZETDM5MD">
    ...
    </main>${renderComponent($$result, "Footer", $$Footer, { "class": "astro-ZETDM5MD" })}` })}`;
