  ...
  return renderTemplate`${maybeRenderHead($$result)}<footer class="astro-SZ7XMLTE">
	<div class="socials astro-SZ7XMLTE">
		...
		<a href="https://ko-fi.com/arcaneenergy" class="astro-SZ7XMLTE">
			<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" class="astro-SZ7XMLTE">
				<path stroke="none" d="M0 0h24v24H0z" fill="none" class="astro-SZ7XMLTE"></path>
				<path d="M3 14c.83 .642 2.077 1.017 3.5 1c1.423 .017 2.67 -.358 3.5 -1c.83 -.642 2.077 -1.017 3.5 -1c1.423 -.017 2.67 .358 3.5 1" class="astro-SZ7XMLTE"></path>
				<path d="M8 3a2.4 2.4 0 0 0 -1 2a2.4 2.4 0 0 0 1 2" class="astro-SZ7XMLTE"></path>
				<path d="M12 3a2.4 2.4 0 0 0 -1 2a2.4 2.4 0 0 0 1 2" class="astro-SZ7XMLTE"></path>
				<path d="M3 10h14v5a6 6 0 0 1 -6 6h-2a6 6 0 0 1 -6 -6v-5z" class="astro-SZ7XMLTE"></path>
				<path d="M16.746 16.726a3 3 0 1 0 .252 -5.555" class="astro-SZ7XMLTE"></path>
			</svg>
		</a>
	</div>
...
const entryGlob = /* #__PURE__ */ Object.assign({"/src/content/posts/2d-physics-sandbox.mdx": () => import('./chunk.2d42725e.js'),"/src/content/posts/animated-explosions-pack-1.mdx": () => import('./chunk.c1495984.js'),"/src/content/posts/control-cube.mdx": () => import('./chunk.7791fd8b.js'),"/src/content/posts/divided-chains-combined-brains.mdx": () => import('./chunk.e19581e4.js'),"/src/content/posts/icosahedron.mdx": () => import('./chunk.22fa7f31.js'),"/src/content/posts/limspace-v1.mdx": () => import('./chunk.2f55aeb4.js'),"/src/content/posts/mergifier.mdx": () => import('./chunk.a92df814.js'),"/src/content/posts/metal-ball-adventures.mdx": () => import('./chunk.ce8d20af.js'),"/src/content/posts/multimesh-scatter.mdx": () => import('./chunk.484830f3.js'),"/src/content/posts/rocket-bounce.mdx": () => import('./chunk.8b360bb1.js'),"/src/content/posts/sm-pdf-viewer.mdx": () => import('./chunk.86507f1a.js'),"/src/content/posts/sm-text-editor.mdx": () => import('./chunk.39723b22.js'),"/src/content/posts/squash-stretch-shader.mdx": () => import('./chunk.8c4b80bf.js'),"/src/content/posts/tilemap-level-editor.mdx": () => import('./chunk.d7c88cf6.js'),"/src/content/posts/top-down-shooter-tutorial-series.mdx": () => import('./chunk.c4c0cdae.js'),"/src/content/posts/vignette-shader.mdx": () => import('./chunk.4fb5f895.js'),"/src/content/posts/voxelgi-scene.mdx": () => import('./chunk.6c0829f5.js'),"/src/content/posts/walking-simulator.mdx": () => import('./chunk.88179af1.js'),"/src/content/posts/whiteboard.mdx": () => import('./chunk.45af6866.js')
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/posts/2d-physics-sandbox.mdx": () => import('./chunk.d5789d46.js'),"/src/content/posts/animated-explosions-pack-1.mdx": () => import('./chunk.0e203ea4.js'),"/src/content/posts/control-cube.mdx": () => import('./chunk.88c17469.js'),"/src/content/posts/divided-chains-combined-brains.mdx": () => import('./chunk.ecc6c985.js'),"/src/content/posts/icosahedron.mdx": () => import('./chunk.14a70d41.js'),"/src/content/posts/limspace-v1.mdx": () => import('./chunk.041e5a0e.js'),"/src/content/posts/mergifier.mdx": () => import('./chunk.5168fe98.js'),"/src/content/posts/metal-ball-adventures.mdx": () => import('./chunk.849b34e6.js'),"/src/content/posts/multimesh-scatter.mdx": () => import('./chunk.9b47dd9a.js'),"/src/content/posts/rocket-bounce.mdx": () => import('./chunk.941afb2e.js'),"/src/content/posts/sm-pdf-viewer.mdx": () => import('./chunk.a90ff192.js'),"/src/content/posts/sm-text-editor.mdx": () => import('./chunk.c45c2060.js'),"/src/content/posts/squash-stretch-shader.mdx": () => import('./chunk.833746c5.js'),"/src/content/posts/tilemap-level-editor.mdx": () => import('./chunk.ac53321b.js'),"/src/content/posts/top-down-shooter-tutorial-series.mdx": () => import('./chunk.a483a09c.js'),"/src/content/posts/vignette-shader.mdx": () => import('./chunk.2b49a17a.js'),"/src/content/posts/voxelgi-scene.mdx": () => import('./chunk.3dc8ff46.js'),"/src/content/posts/walking-simulator.mdx": () => import('./chunk.41f49d29.js'),"/src/content/posts/whiteboard.mdx": () => import('./chunk.736ad8d8.js')
...
const $$Index$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Base", $$Base, { "title": SITE_TITLE, "description": SITE_DESCRIPTION, "class": "astro-J7PV25F6" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<section id="hero" class="relative max-w-full m-0 p-0 astro-J7PV25F6">
		...
		<section class="astro-J7PV25F6">
			...
			<div class="grid md:grid-cols-2 gap-8 py-8 astro-J7PV25F6">
				${FEATURED_POSTS.map((p) => renderTemplate`${renderComponent($$result2, "PostCard", $$PostCard, { "slug": p, "showDatetime": false, "class": "astro-J7PV25F6" })}`)}
			</div>
		</section>
		...
		<section class="astro-J7PV25F6">
			...
			<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 py-8 astro-J7PV25F6">
				${recentPosts.map((p) => renderTemplate`${renderComponent($$result2, "PostCard", $$PostCard, { "slug": p.slug, "showDatetime": false, "class": "astro-J7PV25F6" })}`)}
			</div>
  ...
  return renderTemplate`${maybeRenderHead($$result)}<nav class="astro-ILHXCYM7">
    <ul class="astro-ILHXCYM7">
        ${breadcrumbList.map((breadcrumb, value) => renderTemplate`<li class="astro-ILHXCYM7">
                    <a${addAttribute(breadcrumb["path"], "href")} class="astro-ILHXCYM7">
                        ${breadcrumb["icon"] && renderTemplate`<span class="pr-2 astro-ILHXCYM7">
                                ${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate`${unescapeHTML(breadcrumb["icon"])}` })}
                            </span>`}
                        ${breadcrumb["title"]}
                    </a>
...
const $$Generic = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Base", $$Base, { "title": title, "description": description, "image": heroImage, "class": "astro-FN52SEMU" }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Header", $$Header, { "class": "astro-FN52SEMU" })}${renderComponent($$result2, "Breadcrumbs", $$Breadcrumbs, { "title": title, "class": "astro-FN52SEMU" })}${maybeRenderHead($$result2)}<main class="astro-FN52SEMU">
...
const $$Search = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Generic", $$Generic, { "title": "Search", "description": "Search for posts.", "class": "astro-IPSXRSRH" }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "search-component", "search-component", { "data-message": message, "class": "astro-IPSXRSRH" }, { "default": () => renderTemplate`
        ${maybeRenderHead($$result2)}<input placeholder="Search posts..." type="text" autocomplete="off" autofocus class="astro-IPSXRSRH">
...
const $$Article = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Article;
  const { title, description, datetime, heroImage } = Astro2.props;
  return renderTemplate`${renderComponent($$result, "Base", $$Base, { "title": title, "description": description, "image": heroImage, "class": "astro-UWV4MMHS" }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Header", $$Header, { "class": "astro-UWV4MMHS" })}${renderComponent($$result2, "Breadcrumbs", $$Breadcrumbs, { "title": title, "class": "astro-UWV4MMHS" })}${renderSlot($$result2, $$slots["before-content"])}${maybeRenderHead($$result2)}<main class="astro-UWV4MMHS">
        <div class="info astro-UWV4MMHS">
            ${heroImage && renderTemplate`<img${addAttribute(heroImage, "src")} alt="Image" class="astro-UWV4MMHS">`}
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Article", $$Article, { "title": post.data.title, "description": post.data.description, "datetime": post.data.datetime, "heroImage": post.data.heroImage, "class": "astro-GYSQO7GH" }, { "after-content": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<ul class="tags astro-GYSQO7GH">
...
const $$tag = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Generic", $$Generic, { "title": `Tag:${tag}`, "description": `Pages for Tag:${tag}`, "class": "astro-TGE3Q7AE" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<section class="astro-TGE3Q7AE">
        <span class="astro-TGE3Q7AE">
            ...
            ${renderComponent($$result2, "Tag", $$Tag, { "tag": tag, "sm": false, "gray": false, "class": "astro-TGE3Q7AE" })}
        </span>

        <div class="astro-TGE3Q7AE">
            ${posts.map((post) => renderTemplate`${renderComponent($$result2, "PostCard", $$PostCard, { "slug": post.slug, "showDatetime": true, "class": "astro-TGE3Q7AE" })}`)}
        </div>
    </section>` })}`;
